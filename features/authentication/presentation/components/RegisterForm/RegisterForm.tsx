...
import { registerSchema, RegisterFormData, calculatePasswordStrength, PasswordStrength } from '../../validators/auth.schema';
...
// RegisterFormInner — consomme useRegister via FormProvider
...
// RegisterForm — point d'entrée public
// Fournit le FormProvider à RegisterFormInner
export function RegisterForm() {
  const methods = useForm<RegisterFormData>({
    resolver: zodResolver(registerSchema),
    mode: 'onChange',       // validation en temps réel (force MDP, etc.)
